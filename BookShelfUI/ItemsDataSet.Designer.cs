...
namespace BookShelfUI {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemsRow AddItemsRow(string Name, int Code, string Brand, int Price, decimal Quantity) {
...
namespace BookShelfUI.DataSet1TableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Code] = @Original_Code) AND ([Brand] = @Original_Brand) AND ([Price] =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([Name], [Code], [Brand], [Price], [Quantity]) VALUES (" +
                "@Name, @Code, @Brand, @Price, @Quantity);\r\nSELECT Id, Name, Code, Brand, Price, " +
                "Quantity FROM Items WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [Name] = @Name, [Code] = @Code, [Brand] = @Brand, [Price] = @Price, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Code] = @Original_Code) AND ([Brand] = @Original_Brand) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT Id, Name, Code, Brand, Price, Quantity FROM Items WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=BookStoreDB;Integrated Securit" +
                "y=True;Connect Timeout=60;Encrypt=False;Trust Server Certificate=False";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Code, Brand, Price, Quantity FROM dbo.Items";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Code, string Original_Brand, int Original_Price, decimal Original_Quantity) {
        ...
        public virtual int Insert(string Name, int Code, string Brand, int Price, decimal Quantity) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Code, string Brand, int Price, decimal Quantity, int Original_Id, string Original_Name, int Original_Code, string Original_Brand, int Original_Price, decimal Original_Quantity, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Code, string Brand, int Price, decimal Quantity, int Original_Id, string Original_Name, int Original_Code, string Original_Brand, int Original_Price, decimal Original_Quantity) {
            return this.Update(Name, Code, Brand, Price, Quantity, Original_Id, Original_Name, Original_Code, Original_Brand, Original_Price, Original_Quantity, Original_Id);
        }
    }
